...
export interface ApiCharacterCharacter extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    category: Schema.Attribute.Enumeration<['story', 'production']>;
    character_id: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
...
export interface ApiChatThreadChatThread extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    branch_point: Schema.Attribute.String;
    branched_from: Schema.Attribute.String;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
...
export interface ApiContextItemContextItem extends Struct.CollectionTypeSchema {
  collectionName: 'context_items';
  info: {
    displayName: 'ContextItem';
    pluralName: 'context-items';
    singularName: 'context-item';
  };
  options: {
    draftAndPublish: true;
  };
  attributes: {
    ...
    item_type: Schema.Attribute.Enumeration<
      ['evidence', 'statement', 'financial', 'timeline', 'notes']
    >;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<
      'oneToMany',
      'api::context-item.context-item'
    > &
      Schema.Attribute.Private;
    project: Schema.Attribute.Relation<'manyToOne', 'api::project.project'>;
    publishedAt: Schema.Attribute.DateTime;
...
export interface ApiMessageMessage extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    message_type: Schema.Attribute.Enumeration<
      ['question', 'info_request', 'answer']
    >;
    publishedAt: Schema.Attribute.DateTime;
    role: Schema.Attribute.Enumeration<['user', 'character']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiProjectProject extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    ...
    chat_threads: Schema.Attribute.Relation<
      ...
      'api::chat-thread.chat-thread'
    >;
    context_items: Schema.Attribute.Relation<
      'oneToMany',
      'api::context-item.context-item'
    >;
    createdAt: Schema.Attribute.DateTime;
    ...
    publishedAt: Schema.Attribute.DateTime;
    queries: Schema.Attribute.Relation<'oneToMany', 'api::query.query'>;
    status1: Schema.Attribute.Enumeration<['active', 'closed', 'pending']>;
    updatedAt: Schema.Attribute.DateTime;
    updatedBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
  };
...
export interface ApiQueryQuery extends Struct.CollectionTypeSchema {
  ...
  attributes: {
    character: Schema.Attribute.Relation<
      ...
      'api::character.character'
    >;
    confidence: Schema.Attribute.Text;
    createdAt: Schema.Attribute.DateTime;
    createdBy: Schema.Attribute.Relation<'oneToOne', 'admin::user'> &
      Schema.Attribute.Private;
    final_answer: Schema.Attribute.Text;
    locale: Schema.Attribute.String & Schema.Attribute.Private;
    localizations: Schema.Attribute.Relation<'oneToMany', 'api::query.query'> &
      Schema.Attribute.Private;
    needed_info: Schema.Attribute.Text;
    project: Schema.Attribute.Relation<'manyToOne', 'api::project.project'>;
    provided_info: Schema.Attribute.Text;
    publishedAt: Schema.Attribute.DateTime;
...
declare module '@strapi/strapi' {
  export module Public {
    export interface ContentTypeSchemas {
      ...
      'api::context-item.context-item': ApiContextItemContextItem;
